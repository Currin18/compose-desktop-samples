...
//
// You can follow the progress for HMPP JCM & Android intermediate source sets here:
...
class ImageRepository (
    private val httpsUTL: String
) : Repository<MutableList<String>> {

    override fun get(): MutableList<String> {
        return runBlocking {
            val content = ktorHttpClient.get<String>(httpsUTL)
